...
export const ProjectFooter = ({ project }: {
    ...
    const nextProjectName = project.nextProjectSlug
        ...
        .join(" ");
    return (<footer className="w-full border-t border-border/40 relative overflow-hidden py-24 md:py-48">
            ...
            <div className="w-full max-w-[1400px] mx-auto px-6 md:px-12">
                <div className="grid md:grid-cols-2 gap-12 md:gap-24 items-end">
                    ...
                    <div className="flex flex-col gap-6 md:items-end md:text-right">
                        ...
                        {project.nextProjectSlug && (<Link href={`/projects/${project.nextProjectSlug}`} className="group relative inline-flex flex-col gap-4 md:items-end">
                                ...
                                <div className="flex items-center gap-3 text-lg font-medium text-foreground/60 group-hover:text-foreground transition-colors">
                                    ...
                                    <ArrowRight size={24} className="transform group-hover:translate-x-2 transition-transform duration-500 ease-spring"/>
                                </div>
                            </Link>)}
                    </div>
