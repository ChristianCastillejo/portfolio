...
export const Footer = () => {
    return (<footer className="relative w-full px-4 md:px-6 pb-6 pt-20 z-10">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 md:gap-16 lg:gap-24 mb-12 md:mb-24">
                        ...
                        <div className="grid grid-cols-2 gap-8 md:gap-10 lg:gap-20 content-start lg:justify-end">
                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                {SITEMAP.map((item) => (<Link key={item.name} href={item.href} className="group flex items-center gap-2 text-lg font-display font-bold text-foreground hover:text-accent transition-colors duration-300">
                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                {SOCIAL_LINKS.map((social) => (<Link key={social.name} href={social.href} target="_blank" className="group flex items-center gap-3 text-foreground/70 hover:text-foreground transition-colors duration-300">
