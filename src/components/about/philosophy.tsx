            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12">
                {PHILOSOPHY_ITEMS.map((item, index) => (
                    <motion.article
                        ...
                        className="group relative h-full p-8 md:p-14 rounded-[2rem] md:rounded-[2.5rem] bg-white/40 backdrop-blur-xl border border-white/60 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] hover:bg-white/60 transition-colors transition-shadow duration-500 ease-out flex flex-col items-start"
                    >
