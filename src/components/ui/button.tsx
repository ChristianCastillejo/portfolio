...
const buttonVariants = cva("group relative inline-flex items-center justify-center gap-3 px-8 py-4 rounded-full font-display font-medium text-lg border transition duration-300 ease-out disabled:pointer-events-none disabled:opacity-50 w-full md:w-auto", {
    variants: {
        variant: {
            primary: "bg-primary border-primary text-white shadow-lg shadow-primary/20 hover:bg-primary/90",
            secondary: 'bg-white/80 backdrop-blur-md border-border/60 text-foreground shadow-sm hover:bg-gray-50 hover:border-gray-300 hover:text-black',
        },
        stable: {
